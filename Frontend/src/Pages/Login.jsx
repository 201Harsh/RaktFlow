...
import { FaUser, FaLock, FaSignInAlt, FaEye } from 'react-icons/fa';
              ...
              >
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className="w-full pl-10 pr-10 py-2 bg-gray-800/70 border border-gray-700 rounded-lg text-gray-100 placeholder-gray-300 focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent"
